...
lbls <- porcentagemGastaPorParlamentar$Parlamentar
lbls <- paste(lbls, round(porcentagemGastaPorParlamentar$Gastos, 2))
lbls <- paste(lbls,"%",sep="")

pie(porcentagemGastaPorParlamentar$Gastos, labels = lbls, cex=0.7)
